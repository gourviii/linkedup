...
const weeks = [
  {
    title: (
      <>
        <span className="text-blue-500">Week 1:</span> Profile & Positioning
      </>
    ),
    points: [
  ...
  },
  {
    title: (
      <>
        <span className="text-blue-500">Week 2:</span> Content Clarity
      </>
    ),
    points: [
  ...
  },
  {
    title: (
      <>
        <span className="text-blue-500">Week 3:</span> Engagement & Consistency
      </>
    ),
    points: [
  ...
  },
  {
    title: (
      <>
        <span className="text-blue-500">Week 4:</span> Growth & Momentum
      </>
    ),
    points: [
...
const LinkedInMakeover = () => {
  return (
    ...
    <section
      id="workwithme"
      className="px-6 -mt-20 md:mt-0 py-25 max-w-7xl mx-auto "
    >
      <h1 className="text-3xl md:text-4xl font-bold text-center  ">
        Frame <span className="text-blue-500">Work</span>
      </h1>
      {/* Underline */}
      <motion.div
        initial={{ width: 0 }}
        ...
        viewport={{ once: true }}
        className="w-30 h-1 bg-blue-500 mt-3 mb-8 rounded-full mx-auto"
      />
      {/* Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 ">
        {weeks.map((week, index) => (
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-xl p-6  hover:shadow-2xl"
          >
            ...
            <p className="font-semibold text-blue-600">Result: {week.result}</p>
          </motion.div>
        ))}
      </div>
